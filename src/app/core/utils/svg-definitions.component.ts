export class SvgDefinitionsComponent {
  ...
  initializeSvgDefinitions() {
    ...
    if (container && container.classList.contains("app-svg-definitions")) {
      container.innerHTML = `
        <svg
          width="0"
          height="0"
        ...
        >
          ...
          <symbol viewBox="0 0 24 24" id="roadmap">
            <g fill="currentColor">
              <path
          ...
          <symbol viewBox="0 0 24 24" id="projectPage">
            <g fill="currentColor">
          ...
          <symbol viewBox="0 0 24 24" id="shortcut">
            <g fill="currentColor" fill-rule="evenodd">
              ...
              ></path>
              <path
                d="M19 5V3.99A1 1 0 0018 3c-.556 0-1 .444-1 .99V5h-1a1 1 0 000 2h1v1.01A1 1 0 0018 9c.556 0 1-.444 1-.99V7h1a1 1 0 000-2h-1z"
              ></path>
            </g>
          </symbol>
          ...
          <symbol viewBox="0 0 179 32" id="jira">
            <svg
              viewBox="0 0 179 32"
              xmlns="http://www.w3.org/2000/svg"
              focusable="false"
          ...
          <symbol viewBox="0 0 32 32" id="jiraIcon">
            <defs>
              <linearGradient
                x1="108.695%"
                x2="12.439%"
          ...
          <symbol viewBox="0 0 24 24" id="thunder">
            ...
            <path
              ...
              stroke="currentColor" fill="#fff" stroke-width="1.95489" stroke-linejoin="round"></path>
            </g>
          </symbol>
          ...
          <symbol viewBox="0 0 24 24" id="threedot">
            <g fill="currentColor" fill-rule="evenodd">
          ...
          <symbol viewBox="0 0 16 16" id="story">
            <g
              xmlns="http://www.w3.org/2000/svg"
              id="Story"
              xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"
          ...
          <symbol viewBox="0 0 24 24" id="circleIndicator">
            <circle
              class="opacity-10"
              cx="12"
              cy="12"
          ...
          <symbol viewBox="0 0 16 16" id="blueCheck">
            <g
              xmlns="http://www.w3.org/2000/svg"
              id="Page-1"
              stroke="none"
          ...
          <symbol viewBox="0 0 24 24" id="lock">
            <g fill="currentColor" fill-rule="evenodd">
              <path
                d="M5 11.009C5 9.899 5.897 9 7.006 9h9.988A2.01 2.01 0 0119 11.009v7.982c0 1.11-.897 2.009-2.006 2.009H7.006A2.009 2.009 0 015 18.991V11.01zM12 17a2 2 0 100-4 2 2 0 000 4z"
              ></path>
              <path
                d="M8 6.251v-.249A4.004 4.004 0 0112 2a4 4 0 014 4.002V6.5h-2v-.498A2.001 2.001 0 0012 4c-1.102 0-2 .898-2 2.002V11H8V6.251zm6 .249h2a1 1 0 01-2 0z"
                fill-rule="nonzero"
              ></path>
            </g>
          </symbol>
          ...
          <symbol viewBox="0 0 24 24" id="descending">
          ...
          <symbol viewBox="0 0 24 24" id="ascending">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <path
          ...
          <symbol viewBox="0 0 24 24" id="config">
            <path
              d="M11.701 16.7a5.002 5.002 0 110-10.003 5.002 5.002 0 010 10.004m8.368-3.117a1.995 1.995 0 01-1.346-1.885c0-.876.563-1.613 1.345-1.885a.48.48 0 00.315-.574 8.947 8.947 0 00-.836-1.993.477.477 0 00-.598-.195 2.04 2.04 0 01-1.29.08 1.988 1.988 0 01-1.404-1.395 2.04 2.04 0 01.076-1.297.478.478 0 00-.196-.597 8.98 8.98 0 00-1.975-.826.479.479 0 00-.574.314 1.995 1.995 0 01-1.885 1.346 1.994 1.994 0 01-1.884-1.345.482.482 0 00-.575-.315c-.708.2-1.379.485-2.004.842a.47.47 0 00-.198.582A2.002 2.002 0 014.445 7.06a.478.478 0 00-.595.196 8.946 8.946 0 00-.833 1.994.48.48 0 00.308.572 1.995 1.995 0 011.323 1.877c0 .867-.552 1.599-1.324 1.877a.479.479 0 00-.308.57 8.99 8.99 0 00.723 1.79.477.477 0 00.624.194c.595-.273 1.343-.264 2.104.238.117.077.225.185.302.3.527.8.512 1.58.198 2.188a.473.473 0 00.168.628 8.946 8.946 0 002.11.897.474.474 0 00.57-.313 1.995 1.995 0 011.886-1.353c.878 0 1.618.567 1.887 1.353a.475.475 0 00.57.313 8.964 8.964 0 002.084-.883.473.473 0 00.167-.631c-.318-.608-.337-1.393.191-2.195.077-.116.185-.225.302-.302.772-.511 1.527-.513 2.125-.23a.477.477 0 00.628-.19 8.925 8.925 0 00.728-1.793.478.478 0 00-.314-.573"
              fill="currentColor"
              fill-rule="evenodd"
          ...
          <symbol viewBox="0 0 16 16" id="thunk">
            <rect
              xmlns="http://www.w3.org/2000/svg"
              id="Rectangle-36"
              fill="#904EE2"
          ...
          <symbol viewBox="0 0 16 16" id="priorityMedium" fill="#FFAB00">
            <path
              xmlns="http://www.w3.org/2000/svg"
              class="st0"
          ...
          <symbol viewBox="0 0 16 16" id="priorityHighest">
            <path
              xmlns="http://www.w3.org/2000/svg"
          ...
          <symbol viewBox="0 0 16 16" id="priorityHigh">
            <path
              xmlns="http://www.w3.org/2000/svg"
          ...
          <symbol viewBox="0 0 16 16" id="priorityLow">
            <path
              xmlns="http://www.w3.org/2000/svg"
          ...
          <symbol viewBox="0 0 16 16" id="priorityLowest">
            <path
              xmlns="http://www.w3.org/2000/svg"
          ...
          <symbol viewBox="0 0 24 24" id="questionMark">
            <g fill-rule="evenodd">
              <circle fill="currentColor" cx="12" cy="12" r="10"></circle>
              <circle fill="#fff" cx="12" cy="18" r="1"></circle>
              <path
